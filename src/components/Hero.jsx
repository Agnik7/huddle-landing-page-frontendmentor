...
export default function Hero() {
  return (
    <section className='w-full px-[2rem] flex flex-wrap justify-center'>
        <h1 className='text-[3rem] font-header font-bold text-center mb-[1.3rem]'>Build The Community Your Fans Will Love</h1>
        ...
        <div className='w-full max-w-[54.5rem] h-[14.6rem] flex justify-between mb-[7rem]'>
