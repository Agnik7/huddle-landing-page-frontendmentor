...
import bottomMobile from '../assets/images/bg-section-top-mobile-1.svg';
...
export default function Mid() {
  return (
    <section className='w-full'>
        <img src={topDesktop} alt="Background Pattern" className='w-full hidden sm:block' />
        <img src={topMobile} alt="Background Pattern" className='w-full block sm:hidden'/>
        ...
        <img src={bottomDesktop} alt="Background Pattern" className='w-full hidden sm:block' />
        <img src={bottomMobile} alt="Background Pattern" className='w-full block sm:hidden'/>
