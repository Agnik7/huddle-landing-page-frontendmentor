...
export default function Register() {
  return (
    <section className='w-full flex flex-col items-center mt-[2.3rem] mb-[11rem]'>
        <h2 className='text-[1.5rem] xxxs:text-[2.5rem] font-header font-bold mx-[1rem] md:ml-[1rem] md:mr-0 mb-[2.4rem]'>Ready To Build Your Community?</h2>
